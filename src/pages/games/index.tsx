...
export function GameListPage(props: GameListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getGames({
        relations: ['organization', 'bet.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'rules.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'rules', header: 'Rules', accessorKey: 'rules' },
    { id: 'betting_limit', header: 'betting_limit', accessorKey: 'betting_limit' },
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('bet', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'bet',
          header: 'Bet',
          accessorKey: 'bet',
          cell: ({ row: { original: record } }: any) => record?._count?.bet,
        }
      : null,
