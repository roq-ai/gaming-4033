      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'betting_limit',
              isInvalid: !!formik.errors?.betting_limit,
            }}
            name="betting_limit"
            error={formik.errors?.betting_limit}
            value={formik.values?.betting_limit}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('betting_limit', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
