  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to GAMING - Your Ultimate Destination for an Experience Similar to Betfair.com, Where Every Game is a New Adventure."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1657664072470-99b02c2143f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnYW1pbmd8ZW58MHx8fHwxNjkyMjk0NDI2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to GAMING - Your Ultimate Destination for an Experience Similar to Betfair.com, Where Every Game is a New Adventure.`}
            </Text>
            <Box
